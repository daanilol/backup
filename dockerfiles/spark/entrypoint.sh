...
# Caso a variável de ambiente SPARK_MODE seja "worker"
    ...
    echo "Iniciando o history..."
    sudo /opt/spark/bin/spark-submit --master spark://spark-master:7077 --deploy-mode client /opt/spark/examples/src/main/python/pi.py && /opt/spark/sbin/start-history-server.sh && tail -f /dev/null
